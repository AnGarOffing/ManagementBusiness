        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Servicios_Impuestos_ImpuestoId",
                        column: x => x.ImpuestoId,
                        principalTable: "Impuestos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UtilidadNeta = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    SucursalId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReportesMensuales_Sucursales_SucursalId",
                        column: x => x.SucursalId,
                        principalTable: "Sucursales",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Pedidos_Presupuestos_PresupuestoId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_DetalleFactura_ProductoOrServicio", "(ProductoId IS NOT NULL AND ServicioId IS NULL) OR (ProductoId IS NULL AND ServicioId IS NOT NULL)");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Pago_SingleReference", "(FacturaId IS NOT NULL AND CompraId IS NULL AND GastoId IS NULL) OR (FacturaId IS NULL AND CompraId IS NOT NULL AND GastoId IS NULL) OR (FacturaId IS NULL AND CompraId IS NULL AND GastoId IS NOT NULL)");
                    table.ForeignKey(
                        name: "FK_Pagos_Compras_CompraId",
                        column: x => x.CompraId,
                        principalTable: "Compras",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Productos electrónicos y tecnológicos", "Electrónicos" },
                    { 2, "Vestimenta y accesorios", "Ropa" },
                    { 3, "Artículos para el hogar", "Hogar" },
                    { 4, "Artículos deportivos", "Deportes" },
                    { 5, "Libros y material educativo", "Libros" }
                });

            migrationBuilder.InsertData(
                table: "Impuestos",
                columns: new[] { "Id", "Nombre", "Pais", "Porcentaje" },
                values: new object[,]
                {
                    { 1, "IVA", "México", 16.0m },
                    { 2, "IGV", "Perú", 18.0m },
                    { 3, "GST", "Australia", 10.0m }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 5, "Pago con cheque", "Cheque" }
                });

            migrationBuilder.InsertData(
                table: "Sucursales",
                columns: new[] { "Id", "Direccion", "EsPrincipal", "Nombre" },
                values: new object[] { 1, "Av. Principal 123, Ciudad", true, "Sucursal Principal" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Gastos de alquiler de oficinas o locales", "Alquiler" },
                    { 2, "Gastos de personal y nómina", "Sueldos" },
                    { 3, "Gastos de publicidad y marketing", "Marketing" },
                    { 4, "Luz, agua, gas, internet, etc.", "Servicios Públicos" },
                    { 5, "Gastos de mantenimiento de equipos y locales", "Mantenimiento" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReportesMensuales_Mes_Anio_SucursalId",
                table: "ReportesMensuales",
                columns: new[] { "Mes", "Anio", "SucursalId" });

            migrationBuilder.CreateIndex(
                name: "IX_ReportesMensuales_SucursalId",
                table: "ReportesMensuales",
                column: "SucursalId");

            migrationBuilder.CreateIndex(
                name: "IX_Servicios_ImpuestoId",
                table: "Servicios",
                column: "ImpuestoId");
